...
const Registration = () => {
      ...
      getBase64(ImgFile)
        .then((base64Img) => {
          if (userImgView) {
            ...
            console.error("userImgView element is undefined.");
          }
        })
        .catch((error) => {
  ...
  const onRegistration = () => {
    ...
    let photo = userImgView ? userImgView.src : "";
    // let photo =
    ...
    const user = { Name, email, bio, mobile, password, userImgView };
